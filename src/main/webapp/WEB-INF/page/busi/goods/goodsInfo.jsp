                    ...
                    <%--<div class="card-box">--%>
                        ...
                        <form class="am-form am-form-horizontal">
                            <div class="am-form-group am-form-group-sm am-margin-left am-margin-right">
                                <label for="goodsNo" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0"><label style="color:red">*&nbsp;&nbsp;</label>型号</label>
                                <div class="am-u-sm-4">
                                    <input type="hidden" class="am-form-field am-input-sm am-radius" id="id" >
                                    <input type="text" class="am-form-field am-input-sm am-radius" id="goodsNo" placeholder="请输入型号">
                                </div>

                                <label for="brand" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0"><label style="color:red">*&nbsp;&nbsp;</label>生产商</label>
                                <div class="am-u-sm-4 ">
                                    <input type="text" class="am-form-field am-input-sm am-radius "  id="brand" placeholder="请输入生产商">
                                </div>
                            </div>

                            <div class="am-form-group am-form-group-sm am-margin-left am-margin-right">
                                <label for="packageType" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0"><label style="color:red">*&nbsp;&nbsp;</label>封装</label>
                                <div class="am-u-sm-4">
                                    <input type="text" class="am-form-field am-input-sm am-radius" id="packageType" placeholder="请输入封装">
                                </div>

                                <label for="location" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0">存放位置</label>
                                <div class="am-u-sm-4 ">
                                    <input type="text" class="am-form-field am-input-sm am-radius "  id="location" placeholder="请输入存放位置">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group am-form-group-sm am-margin-left am-margin-right">
                                ...
                                <label for="salePrice" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0"><label style="color:red">*&nbsp;&nbsp;</label>建议售价</label>
                                <div class="am-u-sm-4 am-u-end">
                                    <input type="text" class="am-form-field am-input-sm am-radius" id="salePrice" placeholder="请输入建议售价">
                                </div>
                            </div>

                            <div class="am-form-group am-form-group-sm am-margin-left am-margin-right">
                                <label for="description" class="am-u-sm-2 am-form-label am-text-right am-padding-right-0">备注</label>
                                <div class="am-u-sm-10 am-u-end">
                                    <textarea class="am-form-field am-input-sm am-radius am-u-sm-4" rows="3" id="description" placeholder="请输入备注"></textarea>
                                </div>
                        ...
                        <div id="detailDiv" hidden="hidden">
                            <div class="am-form-group am-form-group-sm am-margin-left am-margin-right am-text-sm">
                                ...
                                <label class="am-radio-inline am-margin-left" id="radio1">
                                    <input type="radio" name="radio" value="1" data-am-ucheck checked> 无
                                </label>
                                <label class="am-radio-inline" id="radio2">
                                    <input type="radio" name="radio" value="0" data-am-ucheck> 有
                                </label>
                            </div>
